...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="One Markdown source, three reading models."
    />
    <style>
      :root {
        color-scheme: light;
  ...
  <body>
    <main>
      <section class="hero">
        ...
        <h1>One Markdown source, three reading models</h1>
        <p class="lede">
          This repository publishes the same canonical Markdown set as VitePress,
          Starlight, and Quartz so the comparison stays focused on navigation,
          defaults, and maintenance cost.
        </p>
      </section>
      <ul class="cards">
